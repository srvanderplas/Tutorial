...
::: callout
Suppose I want to emphasize the change in state population between 2010 and 2019.

I could use a bar chart (showing a few states bordering Nebraska for space), a line chart (showing one line per state), or a box plot (showing variability over time).
