...
-   What is the true value of \_\_\_\_ (and how precisely do I know that value)?
...
Go to [[https://shiny.srvanderplas.com/APL]{.emph}](https://shiny.srvanderplas.com/APL) and start with the Tea Tasting tab.
...
Go to [[https://shiny.srvanderplas.com/APL]{.emph}](https://shiny.srvanderplas.com/APL) and start with the Distributions tab.
...
[[https://shiny.srvanderplas.com/APL/]{.emph}](https://shiny.srvanderplas.com/APL) and click on "One Continuous Variable"
...
![](image/confidence-interval-best-est-uncertanty.svg){width="50%"}
...
[[https://shiny.srvanderplas.com/APL/]{.emph}](https://shiny.srvanderplas.com/APL) and click on "One Categorical Variable"

## One Continuous Variable

-   Statistic: $$t = \frac{\overline x - \mu}{s/\sqrt{n}}$$ where $\overline x$ is the sample mean, $s$ is the sample standard deviation, $\mu$ is the hypothesized mean, and $n$ is the sample size
...
[[https://shiny.srvanderplas.com/APL/]{.emph}](https://shiny.srvanderplas.com/APL) and click on "Categorical + Continuous Variables"
